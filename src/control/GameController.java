...
public class GameController {
  ...
  // Place secondRoom = new Place("Hall of Doom", "This is the final Boss Room...not. It just sounds
  // cool.");
  // Place thirdRoom = new Place("Lighthouse", "You can't see anything in here because the light is
  // blinding.");
  //
  ...
  private static void initGame() {
    ...
    // TODO do all this IN control to avoid this weird constructor mess?
     ...
     * 
     * // character calls List of Inventory for(Item item: character.getItemsInInventory()) {
     * 
